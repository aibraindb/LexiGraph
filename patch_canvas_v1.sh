...
echo
echo "Next:"
echo "  1) Make sure you have streamlit-drawable-canvas installed:"
echo "       pip install streamlit-drawable-canvas==0.9.3"
echo "  2) Start the app page with:"
echo "       streamlit run ui/ocr_tree_canvas.py"
echo
echo "Tip: If some pages show no boxes, verify your OCR indexer returns per-line 'bbox_img' in image pixel coords."
